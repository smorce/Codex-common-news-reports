...
- Generated at: 2026-08-07T00:26:45Z
- Status: Failed
...
```
/8: frames=8, range=20:49-23:49
[INFO]   Window 8/8: frames=4, range=24:15-25:32

[INFO] (2/3) Downloading… '清潔感命！女子は短パンのどこを見てる？大人が絶対気をつけたいポイント！'
[INFO] Downloaded: gemma4_cache\02_d1PPWcbyFo8.mp4 (67.26 MB)
...
[INFO] (3/3) Downloading… '良いシャツの見分け方！名門ナポリシャツの魅力とは？マシンとハンドを徹底解剖 | B.R. Fashion College Lesson.895 ナポリシャツ特集'
...
subprocess.CalledProcessError: Command '['yt-dlp', '--no-update', '--no-warnings', '--extractor-args', 'youtube:lang=ja', '--js-runtimes', 'node', '-f', 'bv*+ba/b', '-o', 'gemma4_cache\\03_A3T9PhBENhc.%(ext)s', 'https://www.youtube.com/watch?v=A3T9PhBENhc', '--no-part', '--no-continue', '--merge-output-format', 'mp4']' returned non-zero exit status 1.
